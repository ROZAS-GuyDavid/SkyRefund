                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="num_fly" class="form-control" placeholder="Enter num_fly">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Numéro de réservation:</strong>
                            <input type="text" name="num_booking" class="form-control" placeholder="Enter num_booking">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Motif:</strong>
                            <textarea class="form-control" style="height:150px" name="reason" placeholder="Enter reason"></textarea>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
